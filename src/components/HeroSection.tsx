    ...
    <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
      ...
      />
        <div className="p-4 relative z-10 w-full text-center">
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Itaque optio doloremque omnis nulla dicta, quaerat minus natus consequatur harum recusandae, sed nihil corporis. Accusantium maiores est nulla, voluptatibus harum nobis, libero officia laborum ipsum mollitia facere ut at totam iure!</p>
            <div className="mt-4">
                <Link href={"/courses"}>
                <div>
                    <Button
